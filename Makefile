...
OBJS	= Buffer.o Common.o MemoryBuffer.o StaticBuffer.o SubBuffer.o CRC16.o CRC32.o \
	...
	LZBSDecompressor.o LZW2Decompressor.o LZW4Decompressor.o LZW5Decompressor.o \
	LZXDecompressor.o MASHDecompressor.o NONEDecompressor.o NUKEDecompressor.o \
	PPDecompressor.o RAKEDecompressor.o RDCNDecompressor.o RLENDecompressor.o \
	RNCDecompressor.o SDHCDecompressor.o SHR3Decompressor.o SHRIDecompressor.o \
	SLZ3Decompressor.o SMPLDecompressor.o SQSHDecompressor.o SXSCDecompressor.o \
	TDCSDecompressor.o TPWMDecompressor.o ZENODecompressor.o \
